    ...
    <footer className="bg-primary text-primary-foreground pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2 mb-4">
              <img src={"/KhanBrother_Logo.jpeg"} width={500} height={500} alt="KB Logo" className="h-8 w-8 object-contain bg-white rounded-sm p-0.5" />
              <span className="font-heading font-bold text-lg tracking-tight">KHAN BROTHERS</span>
            </div>
            <p className="text-primary-foreground/80 text-sm leading-relaxed">
              Engineering Excellence with Reliable Solutions. We deliver high-performance, cost-effective, and sustainable project execution across electrical, solar, IT, and construction sectors.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li className="flex items-start gap-3">
                ...
                <span>Shop # 1, Plot# 1910, Ground Floor, Sector 6J1, Main Awan Road, Jonajjo Town, Manzsoor Colony, Near Ghusia Masjid, Karachi</span>
              </li>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-primary-foreground/60">
          <p>&copy; {new Date().getFullYear()} Khan Brothers Engineering & Solutions. All rights reserved.</p>
