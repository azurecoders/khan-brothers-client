        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2 mb-4">
              <img src={"/logo.png"} width={500} height={500} alt="KB Logo" className="h-8 w-8 object-contain bg-white rounded-sm p-0.5" />
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li className="flex items-start gap-3">
                ...
                <span>123 Engineering Avenue, Industrial District, City, Country</span>
              </li>
              ...
              <li className="flex items-center gap-3">
                ...
                <span>info@khanbrothers.com</span>
              </li>
            </ul>
